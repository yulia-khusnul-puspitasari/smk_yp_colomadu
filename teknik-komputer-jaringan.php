...
<head>
    <meta charset="utf-8">
    <title>SMK Yayasan Pendidikan Colomadu - Teknik Komputer Jaringan</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="keywords" content="SMK Yayasan Pendidikan Colomadu, Teknik Komputer Jaringan, Pendidikan Kejuruan">
    <meta name="description" content="Pelajari program keahlian Teknik Komputer Jaringan di SMK Yayasan Pendidikan Colomadu.">
    ...
    <style>
        * {
        ...
        .hero {
            ...
            height: 500px;
            overflow: hidden;
            background: url('img/teknik-komputer-jaringan-bg.jpg') no-repeat center/cover;
            margin-bottom: 40px;
            width: 100%;
            max-width: 100vw;
        }
...
<!-- Navbar End -->
    ...
    <div class="hero">
        <div class="hero-overlay">
            <div class="hero-content">
                ...
                <p>Keahlian dalam pengelolaan dan keamanan jaringan komputer.</p>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <div class="main-content">
        <div class="dashboard-section">
            <h2>Program Keahlian Teknik Komputer Jaringan</h2>
            <div class="program-panel">
                <div class="program-card">
                    <i class="fas fa-network-wired"></i>
                    <h4>Dasar Jaringan</h4>
                    <p>Pelajari konsep dasar jaringan dan protokol komunikasi.</p>
                </div>
                <div class="program-card">
                    <i class="fas fa-shield-alt"></i>
                    <h4>Keamanan Jaringan</h4>
                    <p>Training keamanan jaringan dan perlindungan dari serangan siber.</p>
                </div>
                <div class="program-card">
                    <i class="fas fa-server"></i>
                    <h4>Administrasi Server</h4>
                    <p>Belajar konfigurasi dan pengelolaan server untuk jaringan.</p>
                </div>
            </div>
        </div>
    </div>
