...
<head>
    <meta charset="utf-8">
    <title>SMK Yayasan Pendidikan Colomadu - Galeri Video</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="keywords" content="SMK Yayasan Pendidikan Colomadu, Galeri Video, Kegiatan Sekolah">
    <meta name="description" content="Lihat koleksi video kegiatan di SMK Yayasan Pendidikan Colomadu.">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="video.php">Video</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div class="hero">
        <div class="hero-overlay">
            <div class="hero-content">
                <h1>Galeri Video</h1>
                <p>Koleksi video kegiatan terbaik dari sekolah.</p>
            </div>
        </div>
    </div>
    <!-- Hero End -->
