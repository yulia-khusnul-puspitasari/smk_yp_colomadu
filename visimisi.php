...
<head>
    <meta charset="utf-8">
    <title>SMK Yayasan Pendidikan Colomadu - Visi dan Misi</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="keywords" content="SMK Yayasan Pendidikan Colomadu, Visi Misi, Pendidikan Teknik">
    <meta name="description" content="Pelajari visi dan misi SMK Yayasan Pendidikan Colomadu untuk mencetak generasi unggul.">
    ...
    <style>
        * {
        ...
        .hero {
            ...
            height: 500px;
            overflow: hidden;
            background: url('img/visimisi-bg.jpg') no-repeat center/cover;
            margin-bottom: 40px;
            width: 100%;
            max-width: 100vw;
        }
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="visimisi.php">Visi dan Misi</a></li>
    ...
    <div class="hero">
        <div class="hero-overlay">
            <div class="hero-content">
                <h1>Visi dan Misi</h1>
                <p>Temukan komitmen kami untuk pendidikan berkualitas.</p>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class="dashboard-section">
            ...
            <div class="vision-mission-panel">
                <div class="vision-card">
                    <h4>Visi</h4>
                    <p>Menciptakan tenaga kerja professional tingkat menengah yang berkarakter bangsa dan mampu berkompetisi di era globalisasi.</p>
                </div>
                <div class="mission-card">
                    <h4>Misi</h4>
                    <p>1. Meningkatkan pembelajaran yang berbasis teknologi. <br> 2.	Melaksanakan pembelajaran yang disiplin, tertib dan efektif. <br> 3. Menghasilkan tamatan yang berjiwa mandiri, berkarakter bangsa dan berkopeten di bidangnya.</p>
                </div>
            </div>
        </div>
    </div>
