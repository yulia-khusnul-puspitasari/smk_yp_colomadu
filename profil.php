...
<head>
    <meta charset="utf-8">
    <title>SMK Yayasan Pendidikan Colomadu - Identitas Sekolah</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="keywords" content="SMK Yayasan Pendidikan Colomadu, Identitas Sekolah, Profil Sekolah">
    <meta name="description" content="Informasi identitas resmi SMK Yayasan Pendidikan Colomadu, termasuk visi, misi, dan data sekolah.">
    ...
    <style>
        * {
        ...
        .hero {
            ...
            height: 500px;
            overflow: hidden;
            background: url('img/profil-bg.jpg') no-repeat center/cover;
            margin-bottom: 40px;
            width: 100%;
            max-width: 100vw;
        }
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="profil.php">Identitas Sekolah</a></li>
    ...
    <div class="hero">
        <div class="hero-overlay">
            <div class="hero-content">
                ...
                <p>Pelajari identitas resmi SMK Yayasan Pendidikan Colomadu.</p>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <!-- <div class="main-content">
        <div class="dashboard-section">
            ...
            <div class="info-panel">
                <div class="info-card">
                    <h4>Nama Sekolah</h4>
                    <p>SMK Yayasan Pendidikan (YP) Colomadu</p>
                </div>
                <div class="info-card">
                    <h4>NSS</h4>
                    <p>324031312002</p>
                ...
                <div class="info-card">
                    <h4>Alamat</h4>
                    <p>Jalan Klegen Jetak , Desa Bolon Kec. Colomadu Kab. Karanganyar Jawa Tengah</p>
                </div>
                <div class="info-card">
                    <h4>Kepala Sekolah</h4>
                    <p>Ari Mustofa,S.Pd.,M.Pd</p>
                </div>
            </div>
        </div>
    </div> -->
    <?php
require 'config/database.php'; // Pastikan path sesuai

// Ambil 1 data sekolah
...
<div class="main-content">
    <div class="dashboard-section">
        ...
        <div class="info-panel">
            ...
            <div class="info-card">
                <h4>Alamat</h4>
                <p><?php echo htmlspecialchars($sekolah['alamat'] ?? 'Belum diatur'); ?></p>
            </div>
            <div class="info-card">
                <h4>Kontak</h4>
                <p><?php echo htmlspecialchars($sekolah['kontak'] ?? 'Belum diatur'); ?></p>
            </div>
            <div class="info-card">
                <h4>Visi</h4>
                <p><?php echo nl2br(htmlspecialchars($sekolah['visi'] ?? 'Belum diatur')); ?></p>
            </div>
            <div class="info-card">
                <h4>Misi</h4>
                <p><?php echo nl2br(htmlspecialchars($sekolah['misi'] ?? 'Belum diatur')); ?></p>
            </div>
        </div>
    </div>
</div>
