    ...
    <div class="hero">
        <div class="hero-overlay">
            <div class="hero-content">
                <h1>Galeri Foto</h1>
                <p>Koleksi momen terbaik dari kegiatan sekolah.</p>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class="dashboard-section">
            ...
            <div class="gallery-panel">
                <div class="gallery-card">
                    <img src="img/foto1.jpg" alt="Kegiatan Siswa">
                    <p>Kegiatan Ekstrakurikuler - 15 Juli 2025</p>
                </div>
                <div class="gallery-card">
                    <img src="img/foto2.jpg" alt="Lomba Kompetensi">
                    <p>Lomba Kompetensi Siswa - 10 Juli 2025</p>
                </div>
                <div class="gallery-card">
                    <img src="img/foto3.jpg" alt="Pelatihan Kerja">
                    <p>Pelatihan Kerja Siswa - 20 Juli 2025</p>
                </div>
            </div>
        </div>
    </div> -->
...
// Ambil semua data dari tabel foto
$fotos = $db->query("SELECT * FROM foto ORDER BY tanggal_upload DESC")->fetchAll(PDO::FETCH_ASSOC);
?>
    ...
    <div class="dashboard-section">
        ...
        <div class="gallery-panel">
            <?php foreach ($fotos as $foto): ?>
                <div class="gallery-card">
                    <img src="<?= htmlspecialchars($foto['nama_file']) ?>" alt="Galeri Foto">
                    <p><?= htmlspecialchars($foto['keterangan']) ?> - <?= date('d M Y', strtotime($foto['tanggal_upload'])) ?></p>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
