...
<head>
    <meta charset="utf-8">
    <title>SMK Yayasan Pendidikan Colomadu - Struktur Organisasi</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="keywords" content="SMK Yayasan Pendidikan Colomadu, Struktur Organisasi, Organisasi Sekolah">
    <meta name="description" content="Lihat struktur organisasi resmi SMK Yayasan Pendidikan Colomadu.">
    ...
    <style>
        * {
        ...
        .hero {
            ...
            height: 500px;
            overflow: hidden;
            background: url('img/struktur-bg.jpg') no-repeat center/cover;
            margin-bottom: 40px;
            width: 100%;
            max-width: 100vw;
        }
    ...
    <div class="hero">
        <div class="hero-overlay">
            <div class="hero-content">
                ...
                <p>Lihat hierarki organisasi SMK Yayasan Pendidikan Colomadu.</p>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class="dashboard-section">
            ...
            <div class="org-chart">
                <ul>
                    <li>Kepala Sekolah
                        <ul>
                            <li>Wakil Kepala Bidang Kurikulum</li>
                            <li>Wakil Kepala Bidang Sarana Prasarana</li>
                            <li>Wakil Kepala Bidang Kesiswaan</li>
                        </ul>
                    </li>
                    <li>Kepala Tata Usaha
                        <ul>
                            <li>Staff Administrasi</li>
                            <li>Keuangan</li>
                        </ul>
                    </li>
                    <li>Kepala Program Keahlian
                        <ul>
                            <li>Koordinator Teknik Permesinan</li>
                            <li>Koordinator Teknik Kendaraan Ringan</li>
                            <li>Koordinator Teknik Komputer Jaringan</li>
                        </ul>
                    </li>
                </ul>
            </div>
