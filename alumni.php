...
<head>
    <meta charset="utf-8">
    <title>SMK Yayasan Pendidikan Colomadu - Alumni</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="keywords" content="SMK Yayasan Pendidikan Colomadu, Alumni, Prestasi Alumni">
    <meta name="description" content="Informasi tentang alumni SMK Yayasan Pendidikan Colomadu dan prestasi mereka.">
    ...
    <style>
        * {
        ...
        .hero {
            ...
            height: 500px;
            overflow: hidden;
            background: url('img/alumni-bg.jpg') no-repeat center/cover;
            margin-bottom: 30px;
            width: 100%;
            max-width: 100vw;
        }
    ...
    <div class="hero">
        <div class="hero-overlay">
            <div class="hero-content">
                <h1>Alumni Kami</h1>
                <p>Keberhasilan alumni yang membanggakan SMK Yayasan Pendidikan Colomadu.</p>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class="dashboard-section">
            ...
            <div class="alumni-grid">
                <div class="alumni-card">
                    <h4>Andi Setiawan</h4>
                    <p>Lulusan 2020, Teknik Permesinan, kini bekerja sebagai Teknisi di PT ABC.</p>
                </div>
                <div class="alumni-card">
                    <h4>Siti Aminah</h4>
                    <p>Lulusan 2021, Teknik Komputer Jaringan, karyawan IT di Startup X.</p>
                </div>
                <div class="alumni-card">
                    <h4>Budi Santoso</h4>
                    <p>Lulusan 2019, Teknik Kendaraan Ringan, pengusaha bengkel independen.</p>
                </div>
            </div>
        </div>
    </div>
