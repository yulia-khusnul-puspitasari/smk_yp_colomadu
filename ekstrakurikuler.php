...
<head>
    <meta charset="utf-8">
    <title>SMK Yayasan Pendidikan Colomadu - Ekstrakurikuler</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="keywords" content="SMK Yayasan Pendidikan Colomadu, Ekstrakurikuler, Kegiatan Siswa">
    <meta name="description" content="Jelajahi berbagai kegiatan ekstrakurikuler di SMK Yayasan Pendidikan Colomadu.">
    ...
    <style>
        * {
        ...
        .hero {
            ...
            height: 500px;
            overflow: hidden;
            background: url('img/ekstrakurikuler-bg.jpg') no-repeat center/cover;
            margin-bottom: 40px;
            width: 100%;
            max-width: 100vw;
        }
        ...
        .icon-img-large {
            ...
            border-radius: 20px;
            margin-bottom: 15px;
            box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2); /* efek bayangan biar lebih hidup */
        }
   ...
   SMK Yayasan Pendidikan Colomadu
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="ekstrakurikuler.php">Ekstrakurikuler</a>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <div class="hero">
        <div class="hero-overlay">
            <div class="hero-content">
                ...
                <p>Kegiatan luar kelas untuk pengembangan bakat siswa.</p>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class="dashboard-section">
            ...
            <div class="activity-panel">
                <div class="activity-card">
                    ...
                    <h4>Bola Kaki</h4>
                    <p>Latihan rutin setiap Sabtu untuk mengasah kemampuan sepak bola.</p>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <h4>Karawitan</h4>
                    <p>Kegiatan membangun dan memprogram robot untuk kompetisi.</p>
                </div>
                <div class="activity-card">
                    <i class="fas fa-microphone"></i>
                    <h4>Hadroh</h4>
                    <p>Latihan drama dan pentas seni untuk meningkatkan kreativitas.</p>
                </div>
                <div class="activity-card">
                    <i class="fas fa-microphone"></i>
                    <h4>Band</h4>
    ...
    <div class="dashboard-section">
        ...
        <div class="activity-panel">
            ...
            <div class="activity-card">
                <img src="img/logo.jpeg" alt="Bola Kaki" class="icon-img-large" />
                <h4>Bola Kaki</h4>
                <p>Latihan rutin setiap Sabtu untuk mengasah kemampuan sepak bola.</p>
            </div>

            <div class="activity-card">
                <img src="img/logo.jpeg" alt="Bola Voli" class="icon-img-large" />
                <h4>Bola Voli</h4>
                <p>Latihan rutin setiap Sabtu untuk mengasah kemampuan sepak bola.</p>
            </div>

            <div class="activity-card">
                <img src="img/karawitan.jpeg" alt="Karawitan" class="icon-img-large" />
                <h4>Karawitan</h4>
                <p>Kegiatan membangun dan memprogram robot untuk kompetisi.</p>
            </div>

            <div class="activity-card">
                <img src="img/hadroh.jpg" alt="Hadroh" class="icon-img-large" />
                <h4>Hadroh</h4>
                <p>Latihan drama dan pentas seni untuk meningkatkan kreativitas.</p>
            </div>

            <div class="activity-card">
                <img src="img/karawitan.jpeg" alt="Band" class="icon-img-large" />
                <h4>Band</h4>
                <p>Latihan drama dan pentas seni untuk meningkatkan kreativitas.</p>
            </div>
